# -*- coding: utf-8 -*-
"""
Created on Fri Oct 10 12:34:51 2025
...
plt.xlim( (-400,400) )
#plt.ylim( (-400,400) )
plt.ylim( (-2*400/Vzoom,2*400/Vzoom) )
#plt.legend()
#plt.title(r'Contour plot of f at $t=$'+str(T) +r', $\delta = $'+str(delta))
...
plt.semilogy(grid.x , y/1.3, label = analytical, linestyle='dashed',color='black')
#plt.legend()
plt.show()
